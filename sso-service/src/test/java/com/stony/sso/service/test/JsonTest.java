...
//        PermissionEntity entity = (PermissionEntity) JacksonUtil.json2Object(xx, PermissionEntity.class);
//        System.out.println(entity);
        PermissionEntity entity = JSON.parseObject(xx, PermissionEntity.class);
        System.out.println(entity);
