...
var App = function () {
    ...
    var handleHorizontalMenu = function () {
        //handle hor menu search VO toggler click
        $('.header').on('click', '.hor-menu .hor-menu-search-VO-toggler', function (e) {
                if ($(this).hasClass('hide')) {
                    $(this).removeClass('hide');
                    $('.header .hor-menu .search-VO').hide();
                } else {
                    $(this).addClass('hide');
                    $('.header .hor-menu .search-VO').show();
                }
                e.preventDefault();
            });

        //handle hor menu search button click
        $('.header').on('click', '.hor-menu .search-VO .btn', function (e) {
                window.location.href = "extra_search.html";
                e.preventDefault();
            });

        //handle hor menu search VO on enter press
        $('.header').on('keypress', '.hor-menu .search-VO input', function (e) {
                if (e.which == 13) {
                    window.location.href = "extra_search.html";
                    return false;
                }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="/static/image/loading.gif" align="">',
