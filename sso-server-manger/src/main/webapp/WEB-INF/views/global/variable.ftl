                ...
                <div class="span12">
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>变量列表</div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>${item.id!}</td>
                                    <td class="hidden-480">${(item.field)!""}</td>
                                    ...
                                    <td>
                                        <a href="javascript:editView(${item.id!},'${(item.field)!}',
                                            '${(item.value)!}','${(item.description)!}' ,${item.available!0})"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addModalTitle">新增变量</h4>
            </div>
            <div class="modal-body">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/update/global/variable" class="form-horizontal" method="post" id="addForm">
                                <div class="control-group">
                                    <label class="control-label">字段</LABEL>
                                    <div class="controls">
                                        <input type="hidden" name="id">
                                        <input type="text" class="span6 m-wrap" placeholder="名称" name="field"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input rows="3" class="span6 m-wrap" placeholder="值" name="value" />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
                                <div class="control-group">
...
<script>
    ...
    function editView(id,field,value,description,live){
        $("#addForm")[0].reset();
        $("#addForm input[name='id']").val(id);
        $("#addForm input[name='field']").val(field);
    ...
    jQuery(document).ready(function() {
        ...
        $("#addItem").click(function () {
            $("#addForm")[0].reset();
            $("#addModalTitle").html("新增变量");
            $("#addModal").modal("toggle");
        });
        $("#submitAddItem").click(function () {
            var field = $("#addForm input[name='field']").val();
            var value = $("#addForm input[name='value']").val();
            var description = $("#addForm textarea[name='description']").val();
            if(isEmpty(field)){
                Messenger().post({
                    message: "变量字段不能为空",
                    type: 'error',
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    var edit = "<a href=\"javascript:void\" class=\"btn mini purple\" id=\"editView_"+data.id+"\"><i class=\"icon-edit\"></i> Edit</a>";
                    var message = "添加变量成功!";
                    ...
                    table.fnAddData(
                            [frist, data.id, data.field, data.value, data.description, joined, lock, edit]
                    );
