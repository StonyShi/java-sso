...
<script src="${media_js_url}/jquery.easyui.min.js" type="text/javascript"></script>
<script src="/static/js/cron.js" type="text/javascript"></script>
</body>
</html>